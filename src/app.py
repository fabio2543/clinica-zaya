...
st.caption("Use o menu **Pages** (barra lateral) para navegar entre: Custos Fixos, Produtos e Procedimentos.")
...
st.info("Dica: mantenha cada página em um arquivo separado para evitar efeitos colaterais durante manutenção.")
